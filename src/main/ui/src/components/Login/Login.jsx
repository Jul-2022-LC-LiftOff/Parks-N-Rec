...
export default function Login() {
	...
	//TODO: changed this but kept original code in comment in case you need to change it back
	...
	return (
		<>
			{/* button on header that opens the log in page/modal */}
		...
		//TODO: I left your original form code in here just in case. Delete if we're good.
